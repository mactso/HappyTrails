...
public class HappyPlayerMove {

	static final Block AIR = Block.getBlockFromName("air");
	static final Potion POTIONSPEED = Potion.getPotionById(1);
	static final Potion POTIONSLOW = Potion.getPotionById(2);
